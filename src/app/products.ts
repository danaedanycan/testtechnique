export interface People {
    ...
    arrivalDate: string;
    house: string;
    assignment?: string; // Optional since not all people have an assignment
    isTeacher: boolean;
  }
...
export const people = [
  ...
  },
  {
      ...
      "firstName": "Ronald",
      "lastName": "Weasley",
      "description": "Has 5 brothers and a sister. \n Son of Arthur and Molly Weasley.",
      "arrivalDate": "01/09/1991",
      "house": "Gryffindor",
      "isTeacher": false
  },
  {
      ...
      "firstName": "Draco",
      "lastName": "Malefoy",
      "description": "Snape's favorite student. \n Son of Lucius and Narcissa Malefoy.",
      "arrivalDate": "01/09/1991",
      "house": "Slytherin",
      "isTeacher": false
  },
  {
      ...
      "firstName": "Neville",
      "lastName": "Longbottom",
      "description": "Raised by his grandmother. \n Son of Alice and Frank Longbottom.",
      "arrivalDate": "01/09/1991",
      "house": "Gryffindor",
      "isTeacher": false
  },
